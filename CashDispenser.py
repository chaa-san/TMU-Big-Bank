class CashDispenser:
    ...
    def dispense_cash(self, amount):
        ...
        bill_values = [100, 50, 20, 10, 5]  # storing the values of different bills
        bill_counts = [0, 0, 0, 0, 0]  # and their corresponding counts

        # Calculates the number of bills required to dispense the remaining amount
        # The remaining amount is then updated to reflect the amount of cash that still needs to be dispensed.
